...
func setupApiController(baseRouter *gin.Engine) {
	...
	//apiRouter.GET("/users/current", apiController.GetCurrentUser)
...
func setupTemplateController(baseRouter *gin.Engine) {
	...
	baseRouter.GET("/session/join/:joinId", templateController.JoinSession)
	baseRouter.POST("/session/join/:joinId", templateController.JoinSession)
